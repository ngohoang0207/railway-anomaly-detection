...
if __name__ == "__main__":
    ...
    if MODE == "rs19":
        ...
        IMAGE_EXTENSION = ".jpg"
        SEG_PATH = os.path.join(args.input_path, "/kaggle/input/railsem19/uint8/rs19_val")  # png
        SEG_EXTENSION = ".png"
        JSON_PATH = os.path.join(args.input_path, "/kaggle/input/railsem19/jsons/rs19_val")  # json
        JSON_EXTENSION = ".json"
