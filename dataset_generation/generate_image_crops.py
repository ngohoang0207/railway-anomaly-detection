...
def main(args):
    ...
    print(f"Found {len(json_list)} jsons from {JSON_PATH})")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path',
                        type=str,
                        default="/path/to/FishyRailsCropped",
                        help='output directory for processed images')
    parser.add_argument('--input_path',
                        type=str,
                        default="/path/to/fishyrails",
                        help='fishyrails directory')
    ...
    # DENSE_LABELS_PATH = os.path.join(os.getcwd(), "fishyrails_config.json")
